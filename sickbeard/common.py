...
class Quality:
    ...
    def nameQuality(name):
        ...
        if checkName(["(pdtv|hdtv|dsr|dlmux).(xvid|x264)"], all) and not checkName(["(720|1080)[pi]"], all):
            return Quality.SDTV
            ...
            return Quality.HDTV
        elif checkName(["720p", "web.dl"], all) or checkName(["720p", "itunes", "h.?264"], all) or checkName(["720p", "dlmux"], all):
            return Quality.HDWEBDL
        elif checkName(["720p", "bluray", "x264"], all) or checkName(["720p", "hddvd", "x264"], all)  or checkName(["720p", "bdmux"], all):
...
showLanguages = {'fr':'french',
                 'en':'english',
                 'ita':'italiano'
                 }

languageShortCode = {'french':'fr',
                     'english':'en',
                     'italiano':'it'
                     }